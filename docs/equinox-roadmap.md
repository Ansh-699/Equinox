...
(`docs/equinox-build-record.md`, `docs/equinox-devnet-release-gate.md`)
...
boundary model (`equinox-architecture-v2.md` §5.2) or the risk plane's
...
run `scripts/install-equinox-toolchain.sh` (pinned Anza Agave 4.2.1),
...
serialized runtime harness (`.github/workflows/equinox-runtime.yml`).
...
Measure every latency stage of `equinox-architecture-v2.md` §23.4:
...
The pre-designed lane (`equinox-architecture-v2.md` §20): DBC
