...
source commit `0078fbb` (documentation checkpoint pending this update). The funding clamp correction is committed as
...
- Fresh full gate on current HEAD: `VERIFY_SUMMARY_PATH=/tmp/stockstream-verify-summary-20260921-cancel-all.json NO_DNA=1 bash scripts/verify.sh` finished `VERIFY-OK`; Rust 250, frontend 213, Worker 354, Playwright fixture 54/54, SBF artifact verification, ABI parity, typechecks, lint, and secret scan all passed. Current local artifact SHA-256 is `f29719b2e8b19cd35d3f34188f8f7dbe2b42553aa136072add53108c0baae7b7`; it is not deployed.
