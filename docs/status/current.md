...
- V3 custody wire path (`df3832a`): `cargo test -p stockstream --test
  v3_bundle --test program_boundary` passes 10 + 9 tests; client custody
...
- Devnet program: `H3UogXdaamHi4Ga9ZzrZNNttCRpasZgarexVyNTZvGET`, upgrade
  ...
  deployed bytes sha256 `4943cc8ee0cea94fc3e34b3a112b7adacc6001c5e3a49947bde52cb77e418e26`
  (upgrade signature `42Y8NJRox23BeVtn2uzZmA9jCcLvcsAPSvsaBbU9o3Zocq6bxApWyYzEHHwEAzcbq5Sxwqr5q7yLHaedp2VDZs9m`, slot `501387455`, finalized).
