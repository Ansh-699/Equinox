...
- V3 custody wire path (`df3832a`): `cargo test -p stockstream --test
  v3_bundle --test program_boundary` passes 11 + 9 tests; client custody
...
- V3 session-replace follow-up: `cargo test -p stockstream --test v3_bundle
  ...
  passes; the upgraded artifact is `7b1390452d49785fd878eda351e3872ded478bf434039404923edf0152438500`.
...
- Devnet program: `H3UogXdaamHi4Ga9ZzrZNNttCRpasZgarexVyNTZvGET`, upgrade
  ...
  deployed bytes sha256 `7b1390452d49785fd878eda351e3872ded478bf434039404923edf0152438500`
  (upgrade signature `QxBk18aitY8KtKcAfiwnTefBD5CxgNRVC3fvDdiLUvao9PxK67p4yqHB7EzsfAhxD3a3tqVJAHk6ZGPMavYuYn5`, slot `501390347`, finalized).
