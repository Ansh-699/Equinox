/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: a8a087efce846ee8087d38b452758648)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MarketStream";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PYTH_PRO_FEED_ID" | "PYTH_PRO_MIN_CHANNEL" | "INGESTION_TOKEN" | "PRIVY_APP_ID" | "PRIVY_APP_SECRET" | "PYTH_PRO_API_KEY">> {}
}
