//! Priority 7: a complete, versioned, binary Equinox event ABI.
//!
...
//! `clients/equinox/src/index.ts::decodeEquinoxEvent`).
//!
...
/// Every Equinox event kind. Values are stable across ABI versions --
