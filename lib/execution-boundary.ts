...
export interface RouterBoundary { getAccountAwareBlockhash(writableAccounts: readonly string[]): Promise<string>; submit(serialized: Uint8Array, kind?: string): Promise<{ status: "er_accepted"; sequence: bigint }>; }
