...
export async function executeL1(preview: TransactionPreview, wallet: WalletBoundary, transport: L1Transport, bytes: Uint8Array): Promise<{ preview: TransactionPreview; signature: string; confirmation: "confirmed" | "finalized" }> {
