...
export interface EquinoxEvent { discriminator: number; kind: string; abiVersion: number; sequence: bigint; market: string; timestamp: bigint; payload: Uint8Array; }
export function decodeEquinoxEvent(logLine: string): EquinoxEvent | null {
