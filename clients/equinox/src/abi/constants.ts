/**
 * Canonical Equinox ABI constants.
 *
 * Generated from `programs/equinox/src/` by `tests/abi_manifest.rs`.
 * CI parity test (`npm run check:equinox-abi`) fails if Rust changes
...
export const ORACLE_SNAPSHOT_VERSION = 3;
export const ORACLE_SNAPSHOT_CORE_OFFSET = 12;
export const ORACLE_SNAPSHOT_FEED_ID_OFFSET = 44;
export const ORACLE_SNAPSHOT_CHANNEL_OFFSET = 48;
export const ORACLE_SNAPSHOT_EXPONENT_OFFSET = 49;
export const ORACLE_SNAPSHOT_PRICE_OFFSET = 53;
export const ORACLE_SNAPSHOT_CONFIDENCE_OFFSET = 61;
export const ORACLE_SNAPSHOT_TIMESTAMP_OFFSET = 69;
export const ORACLE_SNAPSHOT_SEQUENCE_OFFSET = 77;
export const ORACLE_SNAPSHOT_STATUS_OFFSET = 86;
export const ORACLE_SNAPSHOT_AUTHENTICATED_OFFSET = 87;
export const ORACLE_SNAPSHOT_REVISION_OFFSET = 88;
