...
export type { InstrumentAccounts, MarketAuthorityAccounts, MarketTransition, PerpMarketAccounts, RegistryAccounts, V3RiskUpdate } from "./abi/registry-instructions";
...
export type { EquinoxEvent } from "./abi/event-decoders";
...
export { EQUINOX_PROGRAM_KEY } from "./abi/transaction";
...
// program itself invokes Equinox via CPI using its own fixed
// `EXTERNAL_UNDELEGATE_DISCRIMINATOR` wire format
// (`[196, 28, 41, 206, 48, 37, 51, 167]`), never a transaction a client
// constructs. See `programs/equinox/src/magicblock.rs::external_undelegate`.
/**
