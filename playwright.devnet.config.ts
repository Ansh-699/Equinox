...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      NEXT_PUBLIC_EQUINOX_MARKET_ADDRESS: CORE,
      NEXT_PUBLIC_EQUINOX_V3_CORE_ADDRESS: CORE,
      NEXT_PUBLIC_EQUINOX_MARKET_SYMBOL: "AAPL-PERP",
      NEXT_PUBLIC_EQUINOX_MARKET_API_URL: MARKET_API,
    },
  },
